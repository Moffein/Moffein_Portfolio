...
Initially, Rocket Jumps calculated blast force like other blast attacks, by juding the blast position and the position of the player on the server. However, movement in Risk of Rain 2 is client-authoritative. As a result, this desync caused Rocket Jump trajectories to be wildly inaccurate for online clients.
