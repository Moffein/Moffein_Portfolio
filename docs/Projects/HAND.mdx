...
hopoo originally experimented with HAN-D in early dev builds of RoR2, but abandoned it due to difficulties with making its kit work in 3D and left behind a half-finished prototype in the files. As a result, there was always a cult following behind the survivor within the Risk of Rain 2 community, wishing he could get added to the game.

[![](images/HAND/Soul.jpg)]()

## Figuring out HAN-D's Kit

Early-on, I had experimented with touching up the hopoo's prototype HAN-D into a workable state, but the biggest limiting factor was figuring out how to adapt HAN-D's kit in a way that would allow it to fight against flying enemies.
...
I experimented with a lot of different skill setups for these 2 skill slots, like adding a dedicated vertical jump skill, scrapping his original skills in favor of other original skills, attempting to make Overclock a passive, and more.
...
I gave a second pass over HAN-D's kit, opting to directly port his original kit, and observing specifically where it was deficient.
